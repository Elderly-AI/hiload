...
* В среднем активные пользователи тикток проводят 60 минут в приложении один за день. Пруфы: [1.](https://www.businessofapps.com/data/tik-tok-statistics/) [2.](https://www.oberlo.com/blog/tik-tok-statistics) [3.](ttps://www.theverge.com/interface/2020/6/10/21285309/tiktok-2020-user-numbers-revenue-smash-hit-mea-culpa)
* За 10 минут пользования сайтом, было использовано 128 мбтрафика и было сделанно 469 запросов. 
При этом на динамику (в большей части медиа данные) пришлось 120мб трафика и 58 запросов. На статику ~8мб и ~400 запросов. Таким образом, за 60 минут пользования сервисом будет израсходованно ~720мб трафика для динамики, ~60мб трафика для статики и будет совершенно 360 запросов для динамики и 2400 запросов для статики. Пруфы: ![img_1](img_1.png) ![img_2](img_2.png)
