...
* Расчитаем стоимость использования облачного сервиса Amazon Web Services. [1.](https://aws.amazon.com/ru/about-aws/global-infrastructure/)
	...
	* Произведём расчёт стоимости, опираясь на [1.](https://aws.amazon.com/ru/ec2/pricing/on-demand/) и [2.](https://aws.amazon.com/ru/ebs/pricing/). При расчёте, при отсутствии требуемой конфигурации бралась ближайшая по аппаратной конфигурации.
	...
	|	        |          CPU         |  Memory  |   SSD    | Кол-во |     Стоимость      |  Стоимость EBS   | Cумма |
	|---------------|----------------------|----------|----------|--------|--------------------|------------------|-------|
	| Балансировка  | 2x Intel(R) 32 cores |  16GB    |  128GB   |   94   | 0,6816 USD/h х 94  | 0,02 USD/h x 94  |       |
	|	        | 2x Intel(R) 32 cores |  16GB    |  128GB   |   225  | 0,6816 USD/h х 225 | 0,02 USD/h x 225 |       |
		
	|	        |          CPU         |  Memory  |   SSD    | Кол-во |      Стоимость     |  Стоимость EBS     | Cумма |
	|---------------|----------------------|----------|----------|--------|--------------------|--------------------|-------|
	|   Фронтенд    | 2x Intel(R) 32 cores |  32GB    |  256GB   |   180  | 0,6816 USD/h х 180 | 0,04 USD/h x 180   |       |
	|	        | 2x Intel(R) 8 cores  |  2048GB  | 1TB x 64 |   990  | 27,488 USD/h x 990 | 10,235 USD/h x 990 |       | 
		
	|	        |          CPU         |  Memory  |    SSD     | Кол-во |      Стоимость     | Стоимость EBS    | Cумма |
	|---------------|----------------------|----------|------------|--------|--------------------|------------------|-------|
	|   Бэкенд      | 2x Intel(R) 32 cores |  128GB   |   128GB    |   71   | 0,889 USD/h  x 71  | 0,02 USD/h x 71  |       |
	|	        | 2x Intel(R) 32 cores |  32GB    | 512GB x 20 |   18   | 0,6816 USD/h х 18  | 1,6 USD/h x 18   |       | 
	|	        | 2x Intel(R) 32 cores |  16GB    | 512GB x 32 |   12   | 0,6816 USD/h х 12  | 2,6 USD/h x 12   |       | 
	|	        | 2x Intel(R) 32 cores |  256GB   | 128GB      |   45   | 1,04 USD/h   x 45  | 0,02 USD/h x 45  |       | 
	|	        | 2x Intel(R) 32 cores |  32GB    | 4TB x 64   |   90   | 0,6816 USD/h х 90  | 40,94 USD/h x 90 |       | 
	|	        | 2x Intel(R) 32 cores |  32GB    | 128GB      |   18   | 0,6816 USD/h х 18  | 0,02 USD/h x 18  |       | 
	|	        | 2x Intel(R) 32 cores |  32GB    | 128GB      |   18   | 0,6816 USD/h х 18  | 0,02 USD/h x 94  |       | 
